view: materials_md {
  sql_table_name: `mus_pro_sap_ctx.MaterialsMD` ;;
  ...
  dimension: date_from_which_the_cross_plant_material_status_is_valid_mstde {
    type: string
    sql: ${TABLE}.DateFromWhichTheCrossPlantMaterialStatusIsValid_MSTDE ;;
  }
  dimension: date_from_which_the_xdistr_chain_material_status_is_valid_mstdv {
    type: string
  ...
  dimension: valid_from_date_datab {
    type: string
